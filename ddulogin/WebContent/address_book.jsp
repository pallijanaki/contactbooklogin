...
<%@page import="com.iberry.bean.contactbook" %>
<%@page import="com.iberry.dao.contactbookdao.contactDao" %>
...
contactDao rs = new contactDao();
int id1 = 0;
contactbook pdetails;

pdetails=new contactbook();
					...
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<form class="form-horizontal" method="POST"
								action="contactbook<>create_update_personaldetail">
